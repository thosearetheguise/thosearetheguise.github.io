...
Come follow along with our [YouTube stream](https://www.youtube.com/@thoseguys1938).
...
- [GTFOBins](https://gtfobins.github.io/gtfobins/dstat/) now has a record for `dstat`. It basically runs through the exact same thing we discovered in our research, but it’s nice to see that it is still updating and could now be discovered in the first place we looked.