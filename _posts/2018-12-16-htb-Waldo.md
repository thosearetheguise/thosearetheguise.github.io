...
```
But didn't the man page say it was cat in reverse? Does this mean that it also prints the file contents backwards? It is easy to test by `tac`ing a file we know what to expect:
```
